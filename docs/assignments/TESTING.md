...
| Hosted CI | Passed on `main`, `workflow/vague-prompt`, and `workflow/precise-prompt` | [Main run](https://github.com/minagayid/signal-desk-ai-lead-triage/actions/runs/36189134571); local run date 2026-09-26 |
